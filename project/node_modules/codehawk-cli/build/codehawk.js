    ...
    const addComplexityToFile = (file) => {
        ...
        try {
            if (file.shouldAnalyze) {
                fileContents = (0, traverseProject_1.getFileContents)(file.fullPath, (_a = options.enableFlow) !== null && _a !== void 0 ? _a : false);
            }
        }
        catch (error) {
        ...
        return {
            ...file,
            complexityReport: complexityReport !== null && complexityReport !== void 0 ? complexityReport : undefined,
